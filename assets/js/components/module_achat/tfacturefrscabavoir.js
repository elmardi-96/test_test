...
$(".edit").on("submit", ".form", function (e) {
  ...
  $.ajax({
    type: "POST",
    url: Routing.generate("t_UaTFacturefrscab_update_avoir", { id: id }),
    data: dta,
    processData: false,
    contentType: false,
    success: function (result) {
...
$("body").on("submit", ".detail_edit", function (e) {
  ...
  $.ajax({
    type: "POST",
    url: Routing.generate("ua_t_facturefrscab_edit_detail", { id: id }),
    success: function (result) {
...
$("body").on("submit", ".detail_form", function (e) {
  ...
  $.ajax({
    type: "POST",
    url: Routing.generate("ua_t_facturefrscab_update_detail", { id: id }),
    data: dta,
    processData: false,
    contentType: false,
    success: function (result) {
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.value) {
        $.ajax({
          type: "DELETE",
          url: Routing.generate("ua_t_facturefrscab_avoir_article_delete", {
            id: id,
            token: token,
          }),
          data: dta,
