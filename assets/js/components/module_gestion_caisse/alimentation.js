...
var tr_alimentation_list_index = $('#grid_index').DataTable({
    ajax: {
        url: Routing.generate('caisse_alimentation_index_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": false,
...
$("body").on('click' ,".new_operation_button", function() {
    ...
    $.ajax({
        type: "POST",
        url: Routing.generate("caisse_alimentation_new", {"dossier": id}),
        processData: false,
        contentType: false,
...
$("body").on('click' ,"#_transfer", function(e) {
    ...
    $.ajax({
        type: "POST",
        url: Routing.generate("caisse_alimentation_transfer", {"dossier": id}),
        processData: false,
        contentType: false,
        success: function (result) {
            console.log(result);
...
$("body").on("click", "#create_caisse", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: Routing.generate("caisse_alimentation_store"),
        data: formData,
        processData: false,
        contentType: false,
        success: function (result) {
...
$("body").on("click", "#transfer_caisse", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: Routing.generate("caisse_alimentation_store_transfer"),
        data: formData,
        processData: false,
        contentType: false,
        success: function (result) {
