...
table.on("init.dt", function (e, settings) {
    ...
    let data = api.data();
    CustomSearchDatatable.CustomSearchText(api, [1 ,5,6], []);
    CustomSearchDatatable.CustomSearchDate(api, [4,3], []);
...
$("#grid tbody").on("click", ".cd_op", function () {
    var url = Routing.generate("module_grs_demande_conge_show", {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var checkbox = document.getElementById('drop-remove');var calendar = new Calendar(calendarEl, {
