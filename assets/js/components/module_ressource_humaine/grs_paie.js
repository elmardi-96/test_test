...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('grs_paie_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$('#grid tbody').on('click', '.cd_op', function () {
    var url = Routing.generate('grs_paie_edit', { 'id': $(this).closest('tr').attr('id') });
...
var table = $('#datatable-show').DataTable({
    ...
    ajax: {
        url: Routing.generate('grs_paie_employe_list',{ 'id': $("#_id").val() }) + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
var table1 = $('#datatable-show2').DataTable({
    ajax: {
        url: Routing.generate('grs_paie_detail_employe_list',{ 'id': $("#_id").val() }) + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
var table2 = $('#datatable-generer').DataTable({
    ajax: {
        url: Routing.generate('grs_paie_detail_employe_list_generer',{ 'id': $("#_id").val() }) + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$('.edit').on('submit', '.form', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: Routing.generate("grs_paie_edit", { id: id }),
        data: dta,
        processData: false,
        contentType: false,
...
$('.new').on('submit', '.form', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: Routing.generate('grs_paie_new'),
        data: dta,
        processData: false,
        contentType: false,
        success: function (result) {
            ...
            if (result.errors) {
                ...
                toastr.success(result.message.text, result.message.title, { timeOut: 4000 });
                var url = Routing.generate('grs_paie_show',{'id':result.message.data});
...
$('.employe').on('submit', '.form', function (e) {
  ...
  // alert(id );
    $.ajax({
        type: 'POST',
        url: Routing.generate("grs_paie_emp", { id: id }),
        data: dta,
        processData: false,
        contentType: false,
        success: function (result) {
...
$("#datatable-show tbody").on("click", ".add_emp", function () {
  ...
  var paie=  $("#_id").val();
   ...
   // alert(id);
    ...
    $.ajax({
        type: "GET",
        url: Routing.generate("grs_paie_add_employe", {id: paie , emp:emp}),
...
$("#datatable-show2 tbody").on("click", ".del_emp", function () {
  ...
  .then((result) => {
      if (result.value) {
        $.ajax({
            type: "GET",
            url: Routing.generate("grs_paie_delete_employe", {id: paie , emp:emp}),
  ...
  $(".employe").on("change", function (e) {
    if ($(this).val()) {
     // alert($(this).val());
      $.ajax({
        type: "GET",
        url: Routing.generate("grs_paie_montant_employe", {id: $(this).val()}),
...
$("#_delete").click(function (e) {
    ...
    .then((result) => {
        ...
        if (result.value) {
          ...
          $.ajax({
              type: "GET",
              url: Routing.generate("grs_paie_add_employers", {id: paie}),
    ...
    .then((result) => {
        ...
        if (result.value) {
          ...
          $.ajax({
              type: "GET",
              url: Routing.generate("grs_paie_generer_employers", {id: paie}),
