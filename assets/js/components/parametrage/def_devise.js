...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('def_devise_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$('#grid tbody').on('click', '.cd_op', function () {
    var url = Routing.generate('def_devise_edit', { 'id': $(this).closest('tr').attr('id') });
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.code == 200) {
                            ...
                            var url = Routing.generate('def_devise_index');
                            window.location.href = url;
