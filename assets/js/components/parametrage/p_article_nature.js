...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('p_article_nature_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_article_nature_new"),
  ...
  $(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-nature")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-nature"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-nature"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("serviceId");
    var obj = new Object();
      obj["route"] = "p_article_nature_new";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_article_nature_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("natureId");
    var l = Ladda.create(document.querySelector(".button-edit-nature"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "p_article_nature_edit";
    obj["data"] = dta;
  ...
  $(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "p_article_nature_delete";
      obj["id"] = id;
      obj["token"] = token;
      obj["reloadTable"] = true;
      obj["modal"] = true;
