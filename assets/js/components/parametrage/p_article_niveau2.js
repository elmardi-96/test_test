...
var table = $("#grid").DataTable({
  ajax: {
    url: Routing.generate("p_article_niveau_2_list"), // json datasource
    type: "get",
  },
  deferRender: true,
  stateSave: true,
...
$(".bod").on("submit", ".form2", function (e) {
  ...
  if ($(document.activeElement).hasClass("button-save-add-niveau2")) {
    //alert()
    var l = Ladda.create(document.querySelector(".button-save-add-niveau2"));
    var goto = 1;
  } else {
...
$("#grid tbody").on("click", ".cd_op", function () {
  $.ajax({
    type: "POST",
    url: Routing.generate("p_article_niveau_2_edit", {
