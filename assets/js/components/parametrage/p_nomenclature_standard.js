...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('p_nomenclature_standard_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_nomenclature_standard_new"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_nomenclature_standard_edit", {
