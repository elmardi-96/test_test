...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('p_situation_familiale_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_situation_familiale_new"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_situation_familiale_edit", {
