...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('p_comptemasse_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_comptemasse_new"),
  ...
  $(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-comptemasse")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-comptemasse"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-comptemasse"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("modepaiementId");
    var obj = new Object();
      obj["route"] = "p_comptemasse_new";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_comptemasse_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("comptemasseId");
    var l = Ladda.create(document.querySelector(".button-edit-comptemasse"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "p_comptemasse_edit";
    obj["data"] = dta;
  ...
  $(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "p_comptemasse_delete";
      obj["id"] = id;
      obj["token"] = token;
      obj["reloadTable"] = true;
      obj["modal"] = true;
