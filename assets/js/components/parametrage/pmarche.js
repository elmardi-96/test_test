...
var table = $("#grid").DataTable({
  ajax: {
    url: Routing.generate("p_marche_list"), // json datasource
    type: "get",
  },
  deferRender: true,
  stateSave: true,
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchText(api, [1, 2,8, 3], []);
...
$(".add").click(function (e) {
  $.ajax({
    type: "POST",
    url: Routing.generate("p_marche_new"),
...
$("#grid tbody").on("click", ".cd_op,.CD_OP", function () {
  $.ajax({
    type: "POST",
    url: Routing.generate("p_marche_edit", {
