...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('p_unite_list'), // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_unite_new"),
  ...
  $(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-unite")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-unite"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-unite"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("serviceId");
    var obj = new Object();
      obj["route"] = "p_unite_new";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("p_unite_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("uniteId");
    var l = Ladda.create(document.querySelector(".button-edit-unite"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "p_unite_edit";
    obj["data"] = dta;
