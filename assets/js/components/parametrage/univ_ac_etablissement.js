...
var table = $("#grid").DataTable({
  ajax: {
    url: Routing.generate("univ_ac_etablissement_list") + location.search, // json datasource
    type: "get",
  },
  deferRender: true,
  stateSave: true,
  lengthMenu: [
    [25, 50, 100, 200, 20000000],
    [25, 50, 100, 200, "All"],
  ],
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchSelect(api, [4, 6], []);
  CustomSearchDatatable.CustomSearchDate(api, [5], []);
...
$(".bod").on("click", "._delete", function (e) {
  ...
  if (id) {
    var obj = new Object();
    obj["route"] = "univ_ac_etablissement_delete";
    obj["id"] = id;
    obj["token"] = token;
...
$(".add").click(function (e) {
  $.ajax({
    type: "POST",
    url: Routing.generate("univ_ac_etablissement_add"),
...
$(".bod").on("submit", ".form", function (e) {
  ...
  var selector = $(this);
  if ($(document.activeElement).hasClass("button-save-add-etablissement")) {
      //alert()
    var l = Ladda.create(document.querySelector(".button-save-add-etablissement"));
    var goto = 1;
  } else {
    var l = Ladda.create(document.querySelector(".button-save-etablissement"));
    var goto = 0;
  }
  l.start();
  var id = $("#test").data("etablissementId");
  var obj = new Object();
    obj["route"] = "univ_ac_etablissement_add";
    obj["data"] = dta;
    obj["parametre"] = null;
    obj["l"] = l;
...
$("#grid tbody").on("click", ".cd_op", function () {
  $.ajax({
    type: "POST",
    url: Routing.generate("univ_ac_etablissement_edit", {
...
$(".bod").on("submit", ".form_edit", function (e) {
  ...
  var id = $("#test").data("etablissementId");
  var l = Ladda.create(document.querySelector(".button-edit-etablissement"));
  l.start();
  var obj = new Object();
  var parametre = { id: id };
  obj["route"] = "univ_ac_etablissement_edit";
  obj["data"] = dta;
