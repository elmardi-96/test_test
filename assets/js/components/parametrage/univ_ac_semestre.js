...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_ac_semestre_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchSelect(api, [4, 3,2,5,6], []);
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_ac_semestre_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-semestre")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-semestre"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-semestre"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("semestreId");
    var obj = new Object();
      obj["route"] = "univ_ac_semestre_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_ac_semestre_add"),
      success: function (result) {
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_ac_semestre_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("semestreId");
    var l = Ladda.create(document.querySelector(".button-edit-semestre"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_ac_semestre_edit";
    obj["data"] = dta;
