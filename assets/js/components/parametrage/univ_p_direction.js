...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_direction_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_p_direction_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-direction")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-direction"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-direction"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("directionId");
    var obj = new Object();
      obj["route"] = "univ_p_direction_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_direction_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_direction_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("directionId");
    var l = Ladda.create(document.querySelector(".button-edit-direction"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_direction_edit";
    obj["data"] = dta;
