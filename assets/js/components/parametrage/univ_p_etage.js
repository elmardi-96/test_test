...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_etage_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchSelect(api, [2,5], []);
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-etage")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-etage"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-etage"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("etageId");
    var obj = new Object();
      obj["route"] = "univ_p_etage_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_etage_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_etage_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("etageId");
    var l = Ladda.create(document.querySelector(".button-edit-etage"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_etage_edit";
    obj["data"] = dta;
