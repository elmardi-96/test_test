...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_frais_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchText(api, [1,7,6,11], []);
  CustomSearchDatatable.CustomSearchSelect(api, [4, 3,2,5,8,9,10,12], []);
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-frai")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-frai"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-frai"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("fraiId");
    var obj = new Object();
      obj["route"] = "univ_p_frais_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_frais_add"),
      success: function (result) {
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_frais_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("fraiId");
    var l = Ladda.create(document.querySelector(".button-edit-frai"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_frais_edit";
    obj["data"] = dta;
