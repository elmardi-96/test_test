...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_grade_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-grade")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-grade"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-grade"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("gradeId");
    var obj = new Object();
      obj["route"] = "univ_p_grade_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_grade_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_grade_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("gradeId");
    var l = Ladda.create(document.querySelector(".button-edit-grade"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_grade_edit";
    obj["data"] = dta;
