...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_matiere_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_p_matiere_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-matiere")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-matiere"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-matiere"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("matiereId");
    var obj = new Object();
      obj["route"] = "univ_p_matiere_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_matiere_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_matiere_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("matiereId");
    var l = Ladda.create(document.querySelector(".button-edit-matiere"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_matiere_edit";
    obj["data"] = dta;
