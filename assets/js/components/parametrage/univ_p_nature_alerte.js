...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_nature_alerte_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_p_nature_alerte_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var obj = new Object();
      obj["route"] = "univ_p_nature_alerte_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_nature_alerte_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_nature_alerte_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_nature_alerte_edit";
    obj["data"] = dta;
