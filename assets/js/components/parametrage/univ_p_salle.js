...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_p_salle_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchText(api, [1,3,4,5,6,7], []);
  CustomSearchDatatable.CustomSearchSelect(api, [2,8], []);
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-salle")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-salle"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-salle"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("salleId");
    var obj = new Object();
      obj["route"] = "univ_p_salle_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_salle_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_p_salle_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("salleId");
    var l = Ladda.create(document.querySelector(".button-edit-salle"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_p_salle_edit";
    obj["data"] = dta;
