...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_pr_nature_epreuve_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
table.on("init.dt", function (e, settings) {
  ...
  CustomSearchDatatable.CustomSearchText(api, [1,2,3,6], []);
  CustomSearchDatatable.CustomSearchSelect(api, [4,5,7,8], []);
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_pr_nature_epreuve_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-epreuve")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-epreuve"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-epreuve"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("epreuveId");
    var obj = new Object();
      obj["route"] = "univ_pr_nature_epreuve_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_pr_nature_epreuve_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_pr_nature_epreuve_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("epreuveId");
    var l = Ladda.create(document.querySelector(".button-edit-epreuve"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_pr_nature_epreuve_edit";
    obj["data"] = dta;
