...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_x_filiere_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_x_filiere_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".bod").on("submit", ".form", function (e) {
    ...
    var selector = $(this);
    if ($(document.activeElement).hasClass("button-save-add-filiere")) {
        //alert()
      var l = Ladda.create(document.querySelector(".button-save-add-filiere"));
      var goto = 1;
    } else {
      var l = Ladda.create(document.querySelector(".button-save-filiere"));
      var goto = 0;
    }
    l.start();
    var id = $("#test").data("filiereId");
    var obj = new Object();
      obj["route"] = "univ_x_filiere_add";
      obj["data"] = dta;
      obj["parametre"] = null;
      obj["l"] = l;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_x_filiere_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_x_filiere_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var id = $("#test").data("filiereId");
    var l = Ladda.create(document.querySelector(".button-edit-filiere"));
    l.start();
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_x_filiere_edit";
    obj["data"] = dta;
