...
var table = $('#grid').DataTable({
    ajax: {
        url: Routing.generate('univ_x_type_bac_list') + location.search, // json datasource
        type: "get",
    },
    "deferRender": true,
    "stateSave": true,
...
$(".bod").on("click", "._delete", function (e) {
    ...
    if (id) {
      var obj = new Object();
      obj["route"] = "univ_x_type_bac_delete";
      obj["id"] = id;
      obj["token"] = token;
...
$(".add").click(function (e) {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_x_type_bac_add"),
  ...
  $("#grid tbody").on("click", ".cd_op", function () {
    $.ajax({
      type: "POST",
      url: Routing.generate("univ_x_type_bac_edit", {
  ...
  $(".bod").on("submit", ".form_edit", function (e) {
    ...
    var obj = new Object();
    var parametre = { id: id };
    obj["route"] = "univ_x_type_bac_edit";
    obj["data"] = dta;
