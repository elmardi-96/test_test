...
//alert();
    ...
    // alert(emp);
      ...
      $.ajax({
        type: "POST",
        url: Routing.generate("compte_consolides_info",{id:id}),
...
var table = $("#grid").DataTable({
    ajax: {
        url: Routing.generate("tr_compte_consolides_list2"), // json datasource
        type: "get",
    },
    deferRender: true,
    serverSide: true,
...
$('#grid tbody').on('click', '.cd_op', function () {
    var url = Routing.generate('tr_compte_consolides_edit', { 'id': $(this).closest('tr').attr('id') });
...
//var params = $('.form').serializeArray();
    ...
    $.ajax({
        type: "POST",
        url: Routing.generate("tr_compte_consolides_mouvement"),
        data: formData,
        processData: false,
        contentType: false,
        success: function (result) {
...
// Start loading
    ...
    $.ajax({ 
        type: 'POST',
        url: Routing.generate('tr_compte_consolides_payment',{'id':id}),
        data: dta,
        processData: false,
        contentType: false,
        success: function (result) {
...
// Start loading
    ...
    $.ajax({ 
        type: 'POST',
        url: Routing.generate('tr_compte_consolides_payment_achat',{'id':id}),
        data: dta,
        processData: false,
        contentType: false,
        success: function (result) {
...
// Start loading
    ...
    $.ajax({ 
        type: 'POST',
        url: Routing.generate('tr_compte_consolides_payment_mouvement',{'id':id}),
        data: dta,
        processData: false,
        contentType: false,
        success: function (result) {
...
// Start loading
    ...
    $.ajax({ 
        type: 'POST',
        url: Routing.generate('tr_compte_consolides_payment_vente',{'id':id}),
        data: dta,
        processData: false,
        contentType: false,
        success: function (result) {
...
$("body").on("click", ".imp_operation", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: Routing.generate("tr_compte_consolides_impression_achat", {id: id}),
        success: function (result) {
                ...
                .then((result) => {
                    if (result.value) {
                        $.ajax({
                            ...
                            processData: false,
                            contentType: false,
                            url: Routing.generate("tr_compte_consolides_apply_transitions", {
                                id: id,
                            }),
                            success: function (result) {
                                if (result.code == 200) {
