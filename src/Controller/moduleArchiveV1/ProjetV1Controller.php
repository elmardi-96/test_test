...
/**
 * @Route("archiveV1/projet")
 */
class ProjetV1Controller extends AbstractController {
    ...
    /**
     * @Route("/", name="module_archive_V1_projet_index",options={"expose"=true}, methods={"GET","POST"})
     */
    public function projet(Request $request, Breadcrumbs $breadcrumbs): Response {

        
        $breadcrumbs->prependRouteItem("Applications", "app");
        $breadcrumbs->addRouteItem("projet", "module_archive_V1_projet_index");
        $projet = $this->getDoctrine()->getRepository(ArcProjet::class)->findAll();

        return $this->render('module_archive_V1/projet/index.html.twig',array('projet' => $projet));

    }
//create_projet

    /**
     * @Route("/newV1", name="module_achive_V1_projet_new", options={"expose"=true}, methods={"GET","POST"})
     */
    public function createProjet(Request $request, Breadcrumbs $breadcrumbs, ValidatorInterface $validator): Response {
        ...
        $breadcrumbs->addRouteItem("projet", "module_archive_V1_projet_index");
        $breadcrumbs->addRouteItem("Create Projet", "module_achive_V1_projet_new");
        //$projet = $this->getDoctrine()->getRepository(ArcProjet::class)->findAll();
        ...
        return $this->render('module_archive_V1/projet/new.html.twig', [
