...
class ArcClient
{
     ...
     * @var string
     *
     * @ORM\Column(name="adresse", type="text", nullable=true, nullable=false)
     */
    private $adresse;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="clientsCreated")
     * @ORM\JoinColumn(name="user_created", referencedColumnName="id")
     */
    private $userCreated;

    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="clientsUpdated")
    ...
    private $userUpdated;
       ...
       /**
     * @ORM\OneToMany(targetEntity="ArcProjet", mappedBy="client")
     */
    private $projets;
