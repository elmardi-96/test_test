...
class ArcProjet {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="DefStatut")
     * @ORM\JoinColumn(name="statut_id", referencedColumnName="id")
     */
    private $statut;

    /**
     * @ORM\ManyToOne(targetEntity="ArcClient", inversedBy="projets")
     * @ORM\JoinColumn(name="client_id", referencedColumnName="id")
     */
    private $client;

    /**
     * @ORM\ManyToOne(targetEntity="ArcTreeCab")
     * @ORM\JoinColumn(name="default_tree_cab_id", referencedColumnName="id")
     */
    private $defaultTreeCab;

    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="projetsCreated")
     * @ORM\JoinColumn(name="user_created", referencedColumnName="id")
     */
    private $userCreated;

    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="projetsUpdated")
     * @ORM\JoinColumn(name="user_updated", referencedColumnName="id")
     */
    private $userUpdated;

    /**
     * @ORM\OneToMany(targetEntity="ArcTree", mappedBy="projet")
     */
    private $saveTrees;
     ...
     * @var array
     *
     * @ORM\Column(name="notification_users_list", type="json_array", nullable=true)
     */
