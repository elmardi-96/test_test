...
class ArcTree {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="saveTreesUpdated")
     * @ORM\JoinColumn(name="user_updated", referencedColumnName="id")
     */
    private $userUpdated;

    /**
     * @ORM\ManyToOne(targetEntity="ArcProjet", inversedBy="saveTrees")
     * @ORM\JoinColumn(name="projet_id", referencedColumnName="id")
     */
    private $projet;

    /**
     * @ORM\OneToMany(targetEntity="ArcNotification", mappedBy="saveTree")
     */
