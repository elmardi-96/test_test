...
class ArcTreeCab {
 ...
 /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="defaultTreesCabCreated")
     * @ORM\JoinColumn(name="user_created", referencedColumnName="id")
     */
    private $userCreated;

    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="defaultTreesCabUpdated")
    ...
    public function setUpdatedValue() {
     ...
     /**
     * @ORM\OneToMany(targetEntity="ArcTreeDet", mappedBy="defaultTreeCab")
     */
