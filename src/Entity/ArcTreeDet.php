...
class ArcTreeDet {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ArcTreeCab", inversedBy="defaultTreesDet")
    ...
    * @ORM\Column(name="parent", type="string", length=255, nullable=true)
    ...
    /**
     * 
     * @ORM\OneToMany(targetEntity="ArcTreeDet", mappedBy="parentSelf" )
     */
    private $children;

    /**
     * Many Categories have One Category.
     * @ORM\ManyToOne(targetEntity="ArcTreeDet", inversedBy="children")
