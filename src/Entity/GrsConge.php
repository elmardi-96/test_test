...
/**
 * @ORM\Entity(repositoryClass="App\Repository\GrsCongeRepository")
 */
class GrsConge
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\DefStatut")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GrsSoldeConge")
    ...
    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="PTypeConge")
