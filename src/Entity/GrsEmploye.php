...
/**
 * @ORM\Entity(repositoryClass="App\Repository\GrsEmployeRepository")
 * @UniqueEntity("email")
 * @Vich\Uploadable
 */
class GrsEmploye
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="PDepartement", inversedBy="departement")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $departement;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PVille")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $ville;
 ...
 /**
  ...
  /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UXBanque")
     * @ORM\JoinColumn(referencedColumnName="id")
   */
  private $banque;
  ...
  /**
   * @ORM\OneToMany(targetEntity="App\Entity\GrsPaie", mappedBy="employe")
   */
  private $grsPaies;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\GrsNoteInterne", mappedBy="employes")
     */
    private $notes;
