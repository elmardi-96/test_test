...
/**
 * @ORM\Entity(repositoryClass="App\Repository\GrsPaieRepository")
 * @UniqueEntity(
 *     fields={"annee", "mois" ,"type" , "dossier"},
 *     errorPath="mois",
 *     message="ce mois est déjà utilisé cette année."
 * )
 */
class GrsPaie
{
    ...
    */
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\GrsPaiedet", mappedBy="cab", cascade={"persist", "remove"})
     */
    private $details;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UpPiece", inversedBy="grsPaies")
     */
    private $piece;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PGlobalParamDet", inversedBy="grsPaies")
     */
    private $type;


     /**
     * @ORM\OneToOne(targetEntity="App\Entity\UGeneralOperation", mappedBy="paie")
     */
    private $operations;
