...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="App\Repository\PArticleNiveauRepository")
...
class PArticleNiveau
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PArticleNiveau", inversedBy="niveaux")
     * @ORM\JoinColumn(name="parent_id", nullable=true)
     */
    private $parent;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PArticleNiveau", mappedBy="parent")
     * @ORM\JoinColumn(nullable=true)
     */
    private $niveaux;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Uarticle", mappedBy="niveau")
     * @ORM\JoinColumn(nullable=true)
     */
    private $articles;
