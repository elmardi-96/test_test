...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PArticleNiveauOldRepository")
...
class PArticleNiveauOld
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PArticleNiveau", inversedBy="pArticleNiveaux")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PArticleNiveau", mappedBy="parentId")
     * @ORM\JoinColumn(nullable=true)
     */
    private $pArticleNiveaux;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Uarticle", mappedBy="niveau1")
     * @ORM\JoinColumn(nullable=true)
     */
    private $uarticles1;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Uarticle", mappedBy="niveau2")
     * @ORM\JoinColumn(nullable=true)
     */
    private $uarticles2;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Uarticle", mappedBy="niveau3")
     * @ORM\JoinColumn(nullable=true)
     */
    private $uarticles3;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Uarticle", mappedBy="niveau4")
     * @ORM\JoinColumn(nullable=true)
     */
    private $uarticles4;
