...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PCompteRepository")
 * @UniqueEntity("code")
...
class PCompte {
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvDeviscab", mappedBy="compte")
     */
    private $uvDeviscabs;


      /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvCommandecab", mappedBy="compte")
     */
    private $commande;
