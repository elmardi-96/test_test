...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PCompteBanqueGeneralRepository")
...
class PCompteBanqueGeneral {
    ...
    private $dateCompte;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="PCompteBanqueType")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TrCharge", mappedBy="compte")
     */
    private $trCharges;
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PCompteBanque", mappedBy="compteBanqueGeneral")
     */
    private $comptes;
