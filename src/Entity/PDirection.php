 ...
 * PDirection
 *
 * @ORM\Table(name="p_direction", uniqueConstraints={@ORM\UniqueConstraint(name="code_direction_2", columns={"code_direction"})}, indexes={@ORM\Index(name="code_direction", columns={"code_direction"})})
 * @ORM\Entity
 */
class PDirection
{
