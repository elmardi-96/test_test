...
class PDossier {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\UPProjet", mappedBy="dossiers")
     */
    private $projets;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\PMarche", mappedBy="dossiers")
     */
    private $marches;
    
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\UsModule" ,cascade={"persist"})
