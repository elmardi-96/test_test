...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PGlobalParamDetRepository")
 */
class PGlobalParamDet
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PGlobalParam", inversedBy="pGlobalParamDets")
     */
    private $cab;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\GrsPaie", mappedBy="type")
     */
    private $grsPaies;
