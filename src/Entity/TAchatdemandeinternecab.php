 ...
 * @ORM\Entity(repositoryClass="App\Repository\TAchatdemandeinternecabRepository")
...
class TAchatdemandeinternecab
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UPAffaire")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TAchatdemandeinternedet", cascade={"persist", "remove"} , mappedBy="cab")
     */
    private $details;
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\DemandStockCab", cascade={"persist", "remove"} , mappedBy="demandeAchat")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UvDeviscab",fetch="EAGER")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UATCommandefrscab", mappedBy="referenceBci")
     */
    private $commandes;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TAchatdemandeinternecabFichier", mappedBy="demande")
     */
    private $fichiers;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PMarche", inversedBy="tAchatdemandeinternecabs")
     */
    private $marche;
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\UvDeviscab", mappedBy="demande", cascade={"persist", "remove"})
