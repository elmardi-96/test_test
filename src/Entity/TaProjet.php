...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TaProjetRepository")
...
class TaProjet
{
    ...
    /**
     * @Assert\NotBlank
     * @ORM\ManyToOne(targetEntity="TaClient")
    ...
    /**
     * @ORM\OneToMany(targetEntity="TaProjetModule", mappedBy="projet")
     */
    private $modules;

    /**
     * @ORM\OneToMany(targetEntity="TaTache", mappedBy="projet")
     */
    private $taches;
