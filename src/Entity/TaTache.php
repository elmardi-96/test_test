...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TaTacheRepository")
...
class TaTache
{
     ...
     * @Assert\Length(
     *      min = 10,
     *      minMessage = "Votre Text est  trop court "
     * )
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TaPriorite")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TaProjetModule" )
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TaProjet" , inversedBy="taches" , cascade={"persist", "remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="TaTacheFile", mappedBy="tache")
     */
    private $tachFiles;
    
    /**
     * @ORM\OneToMany(targetEntity="TaCommentaire", mappedBy="tache")
     */
    private $commentaires;
     ...
     /**
     * @ORM\OneToMany(targetEntity="TaNotification", mappedBy="tache")
     */
