...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TrChargeRepository")
...
class TrCharge {
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="UPPartenaire")
    ...
    /**
     * @ORM\ManyToMany(targetEntity="UaTReglementfrscab", inversedBy="marches")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\TrTransaction", inversedBy="trCharges")
     */
    private $transaction;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TrChargedet", cascade={"persist", "remove"} , mappedBy="cab")
     */
    private $details;
