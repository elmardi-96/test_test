...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TrChargedetRepository")
 * @UniqueEntity(
 *     fields={"cab", "compte"},
 *     errorPath="compte",
 *     message="Compte dèja utilisé."
 * )
 */
class TrChargedet
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\TrCharge" , inversedBy="details")
