...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TrTransactionRepository")
...
class TrTransaction {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PTransactionType")
     */
    private $type;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TrCharge", mappedBy="transaction")
     */
    private $trCharges;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvTReglementcab", mappedBy="transaction")
     */
    private $reglements;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UaTReglementfrscab", mappedBy="transaction")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UGeneralOperation", inversedBy="transactions")
     */
    private $operation;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GrsPaie")
