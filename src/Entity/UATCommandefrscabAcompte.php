...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UATCommandefrscabAcompteRepository")
...
class UATCommandefrscabAcompte {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UATCommandefrscab" , inversedBy="acomptes")
