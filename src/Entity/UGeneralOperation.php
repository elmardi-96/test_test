...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UGeneralOperationRepository")
...
class UGeneralOperation {
    ...
    /**
     * @Assert\NotBlank
     * @ORM\ManyToOne(targetEntity="App\Entity\Avance")
     */
    private $avance;
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PCompteBanque", inversedBy="trCharges")
     * 
     */
    private $compte;
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PCompteBanqueCaisse", inversedBy="trCharges")
     * 
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GrsEmploye")
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\GrsPaie" , inversedBy="operations" )
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TrTransaction", mappedBy="operation")
     */
    private $transactions;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\UaTFacturefrscab", inversedBy="operation")
     */
    private $factureFournisseur;


    /** 
     *  @ORM\OneToOne(targetEntity="App\Entity\UvFacturecab", inversedBy="operation")
     */
