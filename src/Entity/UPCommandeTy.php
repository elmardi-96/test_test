 ...
 * @UniqueEntity("code")
 * @ORM\Entity(repositoryClass="App\Repository\UPCommandeTyRepository")
 * @ORM\Table(name="u_p_commandety", uniqueConstraints={@ORM\UniqueConstraint(name="code", columns={"code"})})
 * 
 */
class UPCommandeTy
{
