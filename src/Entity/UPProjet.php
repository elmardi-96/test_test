 ...
 * @ORM\Entity(repositoryClass="App\Repository\UPProjetRepository")
 * 
 * 
 * 
 * 
...
class UPProjet
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PProjetSous", mappedBy="projet")
     */
    private $sous;
     ...
     * )
     * @ORM\ManyToMany(targetEntity="App\Entity\PDossier", inversedBy="projets")
