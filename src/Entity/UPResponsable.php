...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UPResponsableRepository")
 */
class UPResponsable
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="uPResponsables")
     */
    private $user;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UPProjet", mappedBy="responsable")
     */
    private $uPProjets;
