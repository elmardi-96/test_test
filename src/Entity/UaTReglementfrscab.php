...
class UaTReglementfrscab
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UaTFacturefrscab", inversedBy="tReglementfrs")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UvFacturecab")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TrCharge")
     */
    private $charge;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PCompteBanque")
     * @Assert\NotBlank
     * 
     */
    private $compte;
       ...
       /**
     * @ORM\ManyToOne(targetEntity="App\Entity\TrTransaction", inversedBy="uareglements")
     */
    private $transaction;
