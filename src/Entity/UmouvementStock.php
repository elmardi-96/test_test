...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UmouvementStockRepository")
...
class UmouvementStock
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Uarticle", inversedBy="umouvementStocks")
     */
    private $article;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Udepot", inversedBy="umouvementStocks")
     */
    private $depot;
