...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivAcElementRepository")
...
class UnivAcElement {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivAcModule", inversedBy="elements")
     * @ORM\JoinColumn(referencedColumnName="id")
     * @Assert\NotBlank()
     */
    private $module;
    ...
    /**
     * @ORM\OneToMany(targetEntity="UnivAcEpreuve", mappedBy="element")
     */
    private $epreuves;


      /**
     * @ORM\OneToMany(targetEntity="UnivExControleElement", mappedBy="element")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivPTypeElement", inversedBy="univAcElements")
     */
    private $nature;
