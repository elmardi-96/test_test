...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivAcFormationRepository")
...
class UnivAcFormation {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivAcEtablissement", inversedBy="formations")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $etablissement;

    /**
     * @ORM\OneToMany(targetEntity="UnivAcPromotion", mappedBy="formation")
     */
    private $promotions;
