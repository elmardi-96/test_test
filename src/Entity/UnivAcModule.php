...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivAcModuleRepository")
...
class UnivAcModule {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivPCouleur")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivAcSemestre", inversedBy="modules")
     * @ORM\JoinColumn(referencedColumnName="id")
     * @Assert\NotBlank()
     */
    private $semestre;
     ...
     /**
     * @ORM\OneToMany(targetEntity="UnivAcElement", mappedBy="module",fetch="EAGER")
     */
    private $elements;
