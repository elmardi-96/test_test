...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivAcPromotionRepository")
...
class UnivAcPromotion {
    ...
    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivAcFormation", inversedBy="promotions")
    ...
    /**
     * @ORM\OneToMany(targetEntity="UnivAcSemestre", mappedBy="promotion")
     */
    private $semestres;
