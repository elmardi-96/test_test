...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivAcSemestreRepository")
...
class UnivAcSemestre
{
    ...
    private $coefficientAss;
     ...
     /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivAcPromotion", inversedBy="semestres")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $promotion;
    ...
    public function setUpdatedValue() {
     ...
     /**
     * @ORM\OneToMany(targetEntity="UnivAcModule", mappedBy="semestre")
     */
    private $modules;
