 ...
 *
 * @ORM\Entity 
 * @ORM\Table(name="univ_division_groupe",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_division", columns={"division"})})
...
class UnivDivisionGroupe {
    ...
    /**
     * @ORM\OneToMany(targetEntity="UnivDivisionGroupeDetail", mappedBy="divisionGroupe")
     */
