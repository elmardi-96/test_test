 ...
 * DivisionGroupDetail
 *
 *  @ORM\Entity(repositoryClass="App\Repository\UnivDivisionGroupeDetailRepository")
 *  @ORM\Table(name="univ_division_groupe_detail",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_code_annee_promotion", columns={"code",  "annee_id", "promotion_id"})})
 * @ORM\HasLifecycleCallbacks()
 * 
 * @UniqueEntity(
 *     fields={"code", "annee", "promotion"},
 *     errorPath="divisionGroupe", 
...
class UnivDivisionGroupeDetail {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivDivisionGroupe", inversedBy="divisionGroupeDetails")
     * @ORM\JoinColumn(name="division_groupe_id", referencedColumnName="id")
     */
    private $divisionGroupe;

    /**
     * @ORM\OneToMany(targetEntity="UnivEtudiantGroupe", mappedBy="divisionGroupeDetail")
     */
  ...
  /**
    ...
    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivAcPromotion")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $promotion;
