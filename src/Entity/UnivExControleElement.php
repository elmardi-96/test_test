...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivExControleElementRepository")
 * @ORM\Table(name="univ_ex_controle_element",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_conrolemodule_element", columns={"controle_module_id", "element_id"})})
 * * @ORM\HasLifecycleCallbacks()
 * 
 *  * @UniqueEntity(
 *     fields={"controleModule", "element"},
 *     errorPath="element",
...
class UnivExControleElement {
    ...
    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivExControleModule" , inversedBy="controleElements")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $controleModule;

    /**
     * @ORM\OneToMany(targetEntity="UnivAcEpreuve", mappedBy="controleElement")
     */
    private $controleEpreuves;

    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivAcElement")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $element;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivPTypeElement", inversedBy="controleElements")
     * @Assert\NotBlank()
     */
    private $typeElement;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivExControleEpreuve", mappedBy="controleElement")
     */
    private $univExControleEpreuves;
    
    
     /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivExEnotes", mappedBy="controleElement")
     */
    private $enotes;
