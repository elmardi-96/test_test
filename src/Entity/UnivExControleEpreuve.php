...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivExControleEpreuveRepository")
 * @ORM\HasLifecycleCallbacks()
 * 
 * 
 * * @ORM\Entity(repositoryClass="App\Repository\UnivExControleEpreuveRepository")
 * @ORM\Table(name="univ_ex_controle_epreuve",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_conroleelement_epreuve", columns={"controle_element_id", "nature_epreuve_id"})})
 * * @ORM\HasLifecycleCallbacks()
 * 
 *  * @UniqueEntity(
 *     fields={"controleElement", "natureEpreuve"},
 *     errorPath="natureEpreuve",
...
class UnivExControleEpreuve
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivExControleElement", inversedBy="univExControleEpreuves")
     */
    ...
    /**
     * 
     * @ORM\OneToMany(targetEntity="UnivAcEpreuve" , mappedBy="controleEpreuve")
     * 
     */
    private $epreuves;
