...
/**
 * 
 * @ORM\Entity(repositoryClass="App\Repository\UnivExControlePromotionRepository")
 * @ORM\Table(name="univ_ex_controle_promotion",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_annee_promotion", columns={"annee_id", "promotion_id"})})
 * @ORM\HasLifecycleCallbacks()
 * 
 * @UniqueEntity(
 *     fields={"annee", "promotion"},
 *     errorPath="promotion",
...
class UnivExControlePromotion {
    ...
    private $promotion;
        ...
        /**
     * @ORM\OneToMany(targetEntity="UnivExControleSemestre", mappedBy="controlePromotion")
     */
    private $controleSemestres;
        ...
        /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivExAnotes", mappedBy="controlePromotion")
     */
    private $anotes;
