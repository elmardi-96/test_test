...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivExControleSemestreRepository")
 * @ORM\Table(name="univ_ex_controle_semestre",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_conrolepromotion_semestre", columns={"controle_promotion_id", "semestre_id"})})
 * * @ORM\HasLifecycleCallbacks()
 * 
 *  * @UniqueEntity(
 *     fields={"controlePromotion", "semestre"},
 *     errorPath="semestre",
...
class UnivExControleSemestre {
    ...
    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivExControlePromotion", inversedBy="controleSemestres")
    ...
    /**
     * @Assert\NotBlank()
     * @ORM\ManyToOne(targetEntity="UnivAcSemestre")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $semestre;
    ...
    /**
     * @ORM\OneToMany(targetEntity="UnivExControleModule", mappedBy="controleSemestre")
     */
    ...
    private $userUpdated;
        ...
        /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivExSnotes", mappedBy="controleSemestre")
     */
    private $snotes;
