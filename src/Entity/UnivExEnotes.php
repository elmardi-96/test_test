...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivExEnotesRepository")
 *  @ORM\Table(uniqueConstraints={@ORM\UniqueConstraint(name="_unique_inscription_controle_element", columns={"inscription_id","controle_element_id"})})
 * 
...
class UnivExEnotes
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivExControleElement", inversedBy="enotes" )
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivPEstatut")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $statutS1;
