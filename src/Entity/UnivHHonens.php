...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivHHonensRepository")
...
class UnivHHonens {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivPlEmptime")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivHAlbhon", inversedBy="univHHonens")
     */
    private $brd;
