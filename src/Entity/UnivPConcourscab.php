...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivPConcourscabRepository")
...
class UnivPConcourscab {
    ...
    private $active = true;
     ...
     /**
     * @ORM\ManyToMany(targetEntity="UnivPMatiere" ,cascade={"persist"})
     * @ORM\JoinTable(name="univ_p_concours_matieres")
     */
    private $matieres;
    
        /**
     * @ORM\OneToMany(targetEntity="UnivPConcoursGrille", mappedBy="concourscab")
     */
    private $grilles;
    ...
    private $userUpdated;
       ...
       /**
     * @ORM\OneToMany(targetEntity="UnivPConcoursdet" , mappedBy="concourscab")
     */
    private $details;
