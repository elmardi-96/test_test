...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivPConcoursdetClassementRepository")
 * @ORM\Entity
 * @ORM\Table(name="univ_p_concoursdet_classement")
 * @ORM\HasLifecycleCallbacks()
 * 
 *  *  * @UniqueEntity(
 *     fields={"concoursdet", "natureDemande"},
 *     errorPath="concoursdet",
...
class UnivPConcoursdetClassement {
    ...
    /**
     * @Assert\NotBlank
     * @ORM\ManyToOne(targetEntity="UnivPConcoursdet" , inversedBy="classements")
