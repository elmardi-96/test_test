...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivPEnseignantRepository")
...
class UnivPEnseignant
{
    ...
    private $nature;
      ...
      /**
     * @ORM\ManyToOne(targetEntity="UnivPGrade")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $grade;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\UnivPrProgrammation", mappedBy="enseignants")
     * 
     */
