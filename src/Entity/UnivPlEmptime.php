...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivPlEmptimeRepository")
...
class UnivPlEmptime {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivPrProgrammation")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivDivisionGroupe")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $divisionGroupe;
     ...
     /**
     * @ORM\OneToMany(targetEntity="UnivPlEmptimens", mappedBy="seance")
     */
    private $enseignants;
