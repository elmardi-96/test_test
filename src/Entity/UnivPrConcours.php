...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivPrConcoursRepository")
...
class UnivPrConcours {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivTEtudiant")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $etudiant;

    /**
     * @ORM\ManyToOne(targetEntity="UnivPConcourscab")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $concours;
    ...
    /**
     * @ORM\OneToMany(targetEntity="UnivPrConcoursdet", mappedBy="prConcours")
     */
    private $details;
