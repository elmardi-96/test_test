...
/**
 * 
 * @ORM\Entity(repositoryClass="App\Repository\UnivPrProgrammationRepository")
 * 
 *  @ORM\Table(name="univ_pr_programmation",uniqueConstraints={@ORM\UniqueConstraint(name="_unique_annee_element_natureepreuve", columns={"nature_epreuve_id",  "annee_id", "element_id"})})
 * @ORM\HasLifecycleCallbacks()
 * 
 * @UniqueEntity(
 *     fields={"element", "annee", "natureEpreuve"},
...
class UnivPrProgrammation {
    ...
    private $userUpdated;
        ...
        /**
     * @ORM\ManyToMany(targetEntity="App\Entity\UnivPEnseignant", inversedBy="programmations")
