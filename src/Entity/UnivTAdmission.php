...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTAdmissionRepository")
...
class UnivTAdmission {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivTPreinscription" , inversedBy="admissions")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    ...
    private $userUpdated;
          ...
          /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivTOperationcab" , mappedBy="admission")
     */
