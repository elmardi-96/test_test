...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTAlerteRepository")
...
class UnivTAlerte
{
    ...
    private $inscription;
           ...
           /**
     * @ORM\ManyToOne(targetEntity="UnivPMesureAlerte")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $mesureAlerte;
           ...
           /**
     * @ORM\ManyToOne(targetEntity="UnivPNatureAlerte")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
