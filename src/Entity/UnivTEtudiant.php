...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTEtudiantRepository")
...
class UnivTEtudiant {  
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivPSituation")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivXAcademie")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $academie;

    /**
     * @ORM\ManyToOne(targetEntity="UnivXLangue")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $langueConcours;

    /**
     * @ORM\ManyToOne(targetEntity="UnivXFiliere")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $filiere;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivTPreinscriptionSuivi" , mappedBy="etudiant")
     */
    private $suivis;

  /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivTEtudiantAppel" , mappedBy="etudiant")
     */
    private $appels;
      /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivTPreinscriptionReleveNote" , mappedBy="etudiant")
     */
    private $releves;
    
    
    /**
     * @ORM\OneToMany(targetEntity="UnivTPreinscription", mappedBy="etudiant")
     */
