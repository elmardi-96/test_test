...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTInscriptionRepository")
...
class UnivTInscription {
    ...
    private $statut;
        ...
        /**
     * @ORM\ManyToOne(targetEntity="UnivPSalle")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $salle;
    ...
    private $userUpdated;
         ...
         /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivTOperationcab" , mappedBy="inscription")
     */
