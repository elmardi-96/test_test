...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTPreinscriptionRepository")
 * @ORM\Table(name="univ_t_preinscription")
 * @ORM\HasLifecycleCallbacks()
 * @UniqueEntity(
 *     fields={"etudiant", "formation", "annee"},
 *     errorPath="Preinscription",
 *     message="Cette formation déjà existe dans la table des preinscription."
 * )
 */
class UnivTPreinscription {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivPStatut")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $statut;

    /**
     * @ORM\ManyToOne(targetEntity="UnivTEtudiant", inversedBy="preinscriptions")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $etudiant;
    ...
    private $userUpdated;
     ...
     /**
     * @ORM\ManyToMany(targetEntity="UnivPDocument" ,cascade={"persist"})
    ...
    private $preinscritionDocumentsBource;
      ...
      /**
     * @ORM\OneToMany(targetEntity="App\Entity\UnivTOperationcab" , mappedBy="preinscription")
     */
    private $operationscab;
    
       /**
     * @ORM\OneToMany(targetEntity="UnivTAdmission", mappedBy="preinscription")
     */
    private $admissions;


    /**
       * @ORM\OneToMany(targetEntity="App\Entity\UnivTPreinscriptionFichier", mappedBy="preinscription")
       */
      private $fichiers;
