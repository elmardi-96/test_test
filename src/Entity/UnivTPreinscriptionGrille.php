...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTPreinscriptionGrilleRepository")
 *@UniqueEntity(
 *     fields={"etablissement" ,"formation"},
 *     errorPath="formation",
 *     message="Cette formation déjà existe dans la table Grille."
 * )
 */
class UnivTPreinscriptionGrille
{
    ...
    /**
     * 
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivAcFormation")
     */
    private $formation;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivAcAnnee")
     */
    private $annee;
    ...
    *@Assert\Range(
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivAcEtablissement")
     */
