...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UnivTReglementRepository")
...
class UnivTReglement {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UnivTOperationcab")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $cab;

    /**
     * @ORM\ManyToOne(targetEntity="UnivXModalite")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $modalite;

    /**
     * @ORM\ManyToOne(targetEntity="UnivXBanque")
     * @ORM\JoinColumn(referencedColumnName="id")
     */
    private $banque;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UnivTBrdpaiement", inversedBy="univTReglements")
     */
    private $brd;
