...
//
/**
 * @ORM\Entity(repositoryClass="App\Repository\UsModuleRepository")
 * @ORM\Table(name="us_module"
 * ,uniqueConstraints={@ORM\UniqueConstraint(name="_unique_prefix", columns={"prefix"})}
 * )
...
class UsModule
{
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UsSolution")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UsSousModule", mappedBy="module")
     * @ORM\OrderBy({"id" = "ASC"})
     */
    private $sousModules;
...
//    private $ModulesDossiers;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\UsParametrage", mappedBy="modules")
     */
