...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UsOperationRepository")
 * @ORM\Table(
 * name="us_operation"
 * ,uniqueConstraints={@ORM\UniqueConstraint(name="_unique_sous_module_prefix", columns={"us_sous_module_id", "prefix"})}
 * )
 * @ORM\HasLifecycleCallbacks()
 * 
 *  @UniqueEntity(
 *     fields={"sousModule", "prefix"},
 *     errorPath="prefix",
...
class UsOperation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UsSousModule" , inversedBy="operations")
