...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UsSousModuleRepository")
 */
// 
/**
 * @ORM\Entity(repositoryClass="App\Repository\UsSousModuleRepository")
 * @ORM\Table(
 * name="us_sous_module" 
 * ,uniqueConstraints={@ORM\UniqueConstraint(name="_unique_module_prefix", columns={"us_module_id", "prefix"})}
 * )
 * 
 * @ORM\HasLifecycleCallbacks()
 * @Vich\Uploadable
 *  @UniqueEntity(
 *     fields={"module", "prefix"},
 *     errorPath="prefix",
...
class UsSousModule {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="PGlobalParam")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UsModule" , inversedBy="sousModules")
     * @ORM\JoinColumn(name="us_module_id", referencedColumnName="id")
     */
    private $module;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UsOperation", mappedBy="sousModule")
     *  @ORM\OrderBy({"id" = "ASC"})
     */
    private $operations;
