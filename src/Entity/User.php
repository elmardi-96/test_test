...
class User implements UserInterface, \Serializable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UsGroupe" , inversedBy="users")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GrsSoldeConge")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UPResponsable", mappedBy="user")
     */
    private $uPResponsables;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PMarcheDet", mappedBy="userCreated")
     */
    private $pMarcheDets;
