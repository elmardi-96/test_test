 ...
 * @ORM\Entity(repositoryClass="App\Repository\UvDeviscabRepository")
...
class UvDeviscab
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PComptemasse", inversedBy="uvDeviscabs")
     * @ORM\JoinColumn(nullable=true)
     */
    private $compteMasse;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PCompterubrique", inversedBy="uvDeviscabs")
     */
    private $compteRubrique;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PCompteposte", inversedBy="uvDeviscabs")
     * @ORM\JoinColumn(nullable=true)
     */
    private $comptePoste;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PCompte", inversedBy="uvDeviscabs")
     * @ORM\JoinColumn(nullable=true)
     */
    private $compte;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvDevisdet", cascade={"persist", "remove"} , mappedBy="cab")
     */
    private $details;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvCommandecab", cascade={"persist", "remove"} , mappedBy="devis")
     */
    private $commandes;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvLivraisoncab", mappedBy="devis")
     */
    private $livraison;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvDeviscabFichier", mappedBy="devis")
     */
    private $fichiers;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UvDeviscab")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UvDeviscab", inversedBy="no" , cascade="persist")
     *  @ORM\JoinColumn( referencedColumnName="id",onDelete="SET NULL")
     */
    private $parentId;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvDeviscab", mappedBy="parentId")
     */
    private $no;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PConditionReglement")
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\TAchatdemandeinternecab", inversedBy="devis", cascade={"persist", "remove"})
     */
    private $demande;
    ...
    private $isdeleted;
     ...
     /**
     * 
     * @ORM\ManyToOne(targetEntity="App\Entity\UPService")
