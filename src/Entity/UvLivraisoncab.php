...
class UvLivraisoncab
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UvCommandecab", inversedBy="livraison")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UvLivraisondet", cascade={"persist", "remove"} , mappedBy="cab")
     */
    private $details;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UvFacturecab" , inversedBy="livraisons")
